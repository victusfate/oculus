...
(function() {
  ...
  State = (function() {
    ...
    State.prototype.updateSelf = function(obj, cb) {
      console.log({
        status: 'State.updateSelf, override for specific behavior',
        obj: obj
      });
      return false;
    };
  ...
  StateVal = (function(_super) {
    ...
    StateVal.prototype.updateSelf = function(obj, cb) {
      ...
      console.log(this.name, ' going to return ', pre !== this.val, 'pre', pre, 'post', this.val);
      return pre !== this.val;
    };
